package com.feswork.slide.model.vo;
...
public class Slide {
	...
	public Slide(int festivalNo, String memId, String localCode, String festivalName, Date openDate, Date closeDate,
			int fesLike, String fesDescription, String fesAdd, String fesImage) {
		super();
	...
	public String toString() {
		return "Slide [festivalNo=" + festivalNo + ", memId=" + memId + ", localCode=" + localCode + ", festivalName="
				+ festivalName + ", openDate=" + openDate + ", closeDate=" + closeDate + ", fesLike=" + fesLike
				+ ", fesDescription=" + fesDescription + ", fesAdd=" + fesAdd + ", fesImage=" + fesImage + "]";
	}
