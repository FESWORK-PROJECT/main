			...
			<div id="content2">
				...
				<div class="container">
					<div class="recommendation">
						<h2>나만의 맞춤 축제</h2>
						<p>
							나의 click에 따른 맞춤 축제를 추천해드립니다.<br> 
							(참고: 로그인 후 이용하시면 추천한 축제를 재추천받을 수 없습니다.)
						</p>
				...
				<div class="container">
					...
					<div class="festival-grid">
						<div class="festival-item">
							<td scope="col"><img
								src="https://kfescdn.visitkorea.or.kr/kfes/upload/contents/db/300_2df360c5-f76e-4c00-961f-6cf4781cb195_1.jpg"
								alt="" /></td>
						</div>
